...
def show_home():
    ...
    with col1:
        st.image(r"C:\githome\hipython_rep\Study\house1.png", width=250, caption="서울시 강남구 / 전세 2억")
    with col2:
        st.image(r"C:\githome\hipython_rep\Study\house2.png", width=250, caption="경기도 성남시 / 월세 80만 원")
